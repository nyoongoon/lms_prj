...
import com.prj.lms.service.post.PostService;
...
public class PostController {
    ...
    @GetMapping("/posts")
    public List<PostResponseDto> getList(@ModelAttribute PostSearch postSearch) { //Pageable 대신 **페이징 설정 커스텀**하기 위해 postSearch 객체 사용
